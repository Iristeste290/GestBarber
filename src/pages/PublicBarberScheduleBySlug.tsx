...
import { Clock, CheckCircle2, Scissors, Star, CalendarDays, ChevronRight, ArrowLeft } from "lucide-react";
...
const PublicBarberScheduleBySlug = () => {
  ...
  const { isDateUnavailable } = useAvailableDates({ barberId: barber?.id });
...
export default PublicBarberScheduleBySlug;
